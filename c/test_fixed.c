...
int test_div_2()
{
	...
	fixed64_t_tostring( f, str );
	printf("%s~=9.66666667\n",str);
	return strcmp( str, "9.+(1/2)+(1/8)+(1/32)+(1/128)+(1/512)+(1/2048)+(1/8192)+(1/32768)+(1/131072)+(1/524288)+(1/2097152)+(1/8388608)+(1/33554432)+(1/134217728)+(1/536870912)+(1/2147483648)" );
}
...
int test_div_3()
{
	...
	fixed64_t_tostring( f, str );
	printf("%s~=24.4\n",str);
	return strcmp( str, "24.+(1/4)+(1/8)+(1/64)+(1/128)+(1/1024)+(1/2048)+(1/16384)+(1/32768)+(1/262144)+(1/524288)+(1/4194304)+(1/8388608)+(1/67108864)+(1/134217728)+(1/1073741824)+(1/2147483648)" );
}

int test_cast_1()
{
	fixed64_t n = { 0xFFFFFFFF60000000 }; // -1 + 0.25 + 0.125
	ufixed64_t c = CASTSIGN( n, uint64_t );
...
{
	fixed64_t n = { 0xFFFFFFFF60000000 }; // -1 + 0.25 + 0.125
	fixed32_t c = F64TOF32( n, int32_t );
	fixed64_t_tostring( n, str );
...
{
	fixed64_t n = { 0xFFFFFFFF60000000 }; // -1 + 0.25 + 0.125
	fixed16_t c = F64TOF16( n, int16_t );
	fixed64_t_tostring( n, str );
