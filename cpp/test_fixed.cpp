...
int test_f32_div_2()
{
	...
	string s = f.to_string( );
	cout << f << '\n';
	return !( s == "9.+(1/2)+(1/8)+(1/32)+(1/128)+(1/512)+(1/2048)+(1/8192)+(1/32768)" );
}
...
int test_f32_div_3()
{
	...
	string s = f.to_string( );
	cout << f << '\n';
	return !( s == "24.+(1/4)+(1/8)+(1/64)+(1/128)+(1/1024)+(1/2048)+(1/16384)+(1/32768)" );
}

int test_f32_cast_1()
{
	fixed32_t n = 0xFFFF6000; // -1 + 0.25 + 0.125
	ufixed32_t c = cast<ufixed32_t>( n );
	return n.number ^ c.number;
}
...
int test_f16_div_3()
{
	...
	string s = f.to_string( );
	cout << f << '\n';
	return !( s == "24.+(1/4)+(1/8)+(1/64)+(1/128)" );
}

int test_f16_cast_1()
{
	fixed16_t n = 0xFF60; // -1 + 0.25 + 0.125
	ufixed16_t c = cast<ufixed16_t>( n );
	int16_t rc = ( n.number ^ c.number ); // avoid sign extension
	return rc;
}
